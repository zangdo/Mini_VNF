...
class BatchedGpuQoSRoutingEnv(tf.Module):
    def __init__(self, num_nodes, topology_data, batch_size=1024):
        super().__init__()
    ...
    def step(self, actions):
        ...
        is_deadend = (tf.reduce_sum(next_valid_mask, axis=1) == 0.0) or is_invalid_action
        ...
        needs_hard_reset = updated_fail_count >= 10
